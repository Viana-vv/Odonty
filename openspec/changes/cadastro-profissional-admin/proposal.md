...
- Criar página exclusiva de cadastro de Dentista com nome, e-mail, senha inicial, confirmação, CRO e especialidade.
...
Escopo funcional confirmado pelo usuário. Contrato e detalhes desta proposta seguem para revisão antes do Apply.
